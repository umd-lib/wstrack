...
class WorkstationStatusesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create workstation_status" do
    assert_difference('WorkstationStatus.count') do
      post workstation_statuses_url, params: { workstation_status: { guest_flag: @workstation_status.guest_flag, os: @workstation_status.os, status: @workstation_status.status, user_hash: @workstation_status.user_hash, workstation_name: @workstation_status.workstation_name, workstation_type: @workstation_status.workstation_type } }
    end
  ...
  test "should update workstation_status" do
    patch workstation_status_url(@workstation_status), params: { workstation_status: { guest_flag: @workstation_status.guest_flag, os: @workstation_status.os, status: @workstation_status.status, user_hash: @workstation_status.user_hash, workstation_name: @workstation_status.workstation_name, workstation_type: @workstation_status.workstation_type } }

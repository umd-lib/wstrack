...
edu.umd.lib.wstrack.server.locationMap = [
	...
	MCK6F:[location:'McKeldin Library 6th floor',regex:~/(?i)^LIBRWKMCK[PM]6F.*$/],
	MCK6F1:[location:'McKeldin Library 6th floor RM 6101',regex:~/(?i)^LIBRWKMCK[PM]6F1.*$/],
	...
	EPL1F:[location:'Engineering Library 1st floor',regex:~/(?i)^LIBRWKEPL[PM]1F.*$/],
	EPL2F:[location:'Engineering Library 2nd floor',regex:~/(?i)^LIBRWKEPL[PM]2F.*$/],
	EPL3F:[location:'Engineering Library 3rd floor',regex:~/(?i)^LIBRWKEPL[PM]3F.*$/],

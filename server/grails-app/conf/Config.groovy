...
edu.umd.lib.wstrack.server.locationMap = [
	...
	EPL1F:[location:'STEM Library 1st floor',regex:~/(?i)^LIBRWKSTEM1F.*$/],
	EPL2F:[location:'STEM Library 2nd floor',regex:~/(?i)^LIBRWKSTEM2F.*$/],
	EPL3F:[location:'STEM Library 3rd floor',regex:~/(?i)^LIBRWKSTEM3F.*$/],
